...
Ave_NWB_CU<- function(HUC8,label){
  ...
  for (i in 1:nrow(HUC8@data)){
    HUC8@data$Discharge_ave[i]<-HUC8@data$Discharge_sum[i]/
      length(which(!is.na(HUC8@data[i,c("Discharges_2010","Discharges_2011","Discharges_2012",
  ...
  for (i in 1:nrow(HUC8@data)){
    HUC8@data$Withdrawal_ave[i]<-HUC8@data$Withdrawal_sum[i]/
      length(which(!is.na(HUC8@data[i,c("Withdrawals_2010","Withdrawals_2011","Withdrawals_2012",
  ...
  for (i in 1:nrow(HUC8@data)){
    HUC8@data$NetWB_ave[i]<-HUC8@data$NetWB_sum[i]/
      length(which(!is.na(HUC8@data[i,c("NetWB_2010","NetWB_2011","NetWB_2012",
  ...
  for (i in 1:nrow(HUC8@data)){
    HUC8@data$Consumption_ave[i]<-HUC8@data$Consumption_sum[i]/
      length(which(!is.na(HUC8@data[i,c("Consumption_2010","Consumption_2011","Consumption_2012",
  ...
  for (i in 1:nrow(HUC8@data)){
    HUC8@data$NetWB_t_ave[i]<-HUC8@data$NetWB_t_sum[i]/
      length(which(!is.na(HUC8@data[i,c("NetWB_2010_t","NetWB_2011_t","NetWB_2012_t",
  ...
  for (i in 1:nrow(HUC8@data)){
    HUC8@data$Consumption_t_ave[i]<-HUC8@data$Consumption_t_sum[i]/
      length(which(!is.na(HUC8@data[i,c("Consumption_2010_t","Consumption_2011_t","Consumption_2012_t",
...
HUC8_discharge<- function(HUC8,ECHO_points, label,fileext){
...
#-All Facilities-#
HUC8_discharge(HUC8,ECHO.test,"All Reporting Facilities in All Sectors","all_fac_all_sec")
#-Fully Matched Facilities-#
...
HUC8_discharge(HUC8_ag,ECHO.test_ag,"Agriculture/Irrigation Facilities","all_ag")
...
HUC8_discharge(HUC8_match_ag,ECHO.test_match_ag,"Matched Agriculture/Irrigation Facilities","match_ag")
HUC8_discharge(HUC8_match_commercial,ECHO.test_match_commercial,"Matched Commercial Facilities","macth_commercial")
HUC8_discharge(HUC8_match_industrial,ECHO.test_match_industrial,"Matched Industrial Facilities","match_industrial")
HUC8_discharge(HUC8_match_municipal,ECHO.test_match_municipal,"Matched Municipal Facilities","match_municipal")
...
HUC8_withdrawal<- function(HUC8,VWUDS_points,label,fileext){
...
#-All Facilities-#
HUC8_withdrawal(HUC8,VWUDS.test,"All Reporting Facilities in All Sectors","all_fac_all_sec")
#-Fully Matched Facilities-#
...
HUC8_withdrawal(HUC8_match_ag,VWUDS.test_match_ag,"Matched Agriculture/Irrigation Facilities","match_ag")
...
HUC8_withdrawal(HUC8_match_municipal,VWUDS.test_match_municipal,"Matched Municipal Facilities","match_municipal")
...
HUC8_consumption<- function(HUC8, ECHO_points ,VWUDS_points, label,fileext){
...
HUC8_consumption(HUC8,ECHO.test,VWUDS.test,"All Reporting Facilities in All Sectors","all_fac_all_sector")

#-Fully Matched Facilities-#

HUC8_consumption(HUC8_matched,ECHO.test_matched,VWUDS.test_matched,"Matched Facilities in All Sectors","match_all_sector")

#---Subsetted by Sector---#

#-All Facilities-#
HUC8_consumption(HUC8_energy,ECHO.test_energy,VWUDS.test_energy,"Energy Facilities","all_energy")
HUC8_consumption(HUC8_ag,ECHO.test_ag,VWUDS.test_ag,"Agriculture/Irrigation Facilities","all_ag")
...
HUC8_consumption(HUC8_match_ag,ECHO.test_match_ag,VWUDS.test_match_ag,"Matched Agriculture/Irrigation Facilities","match_ag")
...
HUC8_consumption(HUC8_match_municipal,ECHO.test_match_municipal,VWUDS.test_match_municipal,"Matched Municipal Facilities","match_municipal")

#---Non-Energy Sectors---#

#-All Facilities-#
HUC8_consumption(HUC8_nonenergy,ECHO.test_nonenergy,VWUDS.test_nonenergy,"Non-Energy Facilities","all_nonenergy")

#-Fully Matched Facilities-#
HUC8_consumption(HUC8_match_nonenergy,ECHO.test_match_nonenergy,VWUDS.test_match_nonenergy,"Matched Non-Energy Facilities","match_nonenergy")
...
#-Fully Matched Facilities-#
HUC8_consumption_nopnt(HUC8_match_nonenergy,"Matched Non-Energy Facilities","match_nonenergy")
