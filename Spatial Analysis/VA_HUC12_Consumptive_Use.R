...
HUC12<-readOGR("G:/My Drive/ECHO NPDES/USGS_Consumptive_Use_Updated/HUC.gdb",layer='WBDHU12')
...
Ave_NWB_CU<- function(HUC12,label){
  ...
  for (i in 1:nrow(HUC12@data)){
    HUC12@data$Discharge_ave[i]<-HUC12@data$Discharge_sum[i]/
      length(which(!is.na(HUC12@data[i,c("Discharges_2010","Discharges_2011","Discharges_2012",
  ...
  for (i in 1:nrow(HUC12@data)){
    HUC12@data$Withdrawal_ave[i]<-HUC12@data$Withdrawal_sum[i]/
      length(which(!is.na(HUC12@data[i,c("Withdrawals_2010","Withdrawals_2011","Withdrawals_2012",
  ...
  for (i in 1:nrow(HUC12@data)){
    HUC12@data$NetWB_ave[i]<-HUC12@data$NetWB_sum[i]/
      length(which(!is.na(HUC12@data[i,c("NetWB_2010","NetWB_2011","NetWB_2012",
  ...
  for (i in 1:nrow(HUC12@data)){
    HUC12@data$Consumption_ave[i]<-HUC12@data$Consumption_sum[i]/
      length(which(!is.na(HUC12@data[i,c("Consumption_2010","Consumption_2011","Consumption_2012",
  ...
  for (i in 1:nrow(HUC12@data)){
    HUC12@data$NetWB_t_ave[i]<-HUC12@data$NetWB_t_sum[i]/
      length(which(!is.na(HUC12@data[i,c("NetWB_2010_t","NetWB_2011_t","NetWB_2012_t",
  ...
  for (i in 1:nrow(HUC12@data)){
    HUC12@data$Consumption_t_ave[i]<-HUC12@data$Consumption_t_sum[i]/
      length(which(!is.na(HUC12@data[i,c("Consumption_2010_t","Consumption_2011_t","Consumption_2012_t",
...
HUC12_discharge<- function(HUC12,ECHO_points, label,fileext){
  ...
  path="G:/My Drive/USGS_ConsumptiveUse/Spring, 2019/HUC12 Analysis/Discharges/"
  
  ggsave(filename=paste0(path,"HUC12_discharge_",fileext,".pdf"), 
         plot=plot1, 
...
#-All Facilities-#
HUC12_discharge(HUC12,ECHO.test,"All Reporting Facilities in All Sectors","all_fac_all_sec")
#-Fully Matched Facilities-#
HUC12_discharge(HUC12_matched,ECHO.test_matched,"Matched Facilities in All Sectors","match_all_sector")

#---Subsetted by Sector---#

#-All Facilities-#
HUC12_discharge(HUC12_energy,ECHO.test_energy,"Energy Facilities","all_energy")
HUC12_discharge(HUC12_ag,ECHO.test_ag,"Agriculture/Irrigation Facilities","all_ag")
HUC12_discharge(HUC12_commercial,ECHO.test_commercial,"Commercial Facilities","all_commercial")
HUC12_discharge(HUC12_industrial,ECHO.test_industrial,"Industrial Facilities","all_industrial")
HUC12_discharge(HUC12_municipal,ECHO.test_municipal,"Municipal Facilities","all_municipal")

#-Fully Matched Facilities-#
HUC12_discharge(HUC12_match_energy,ECHO.test_match_energy,"Matched Energy Facilities","match_energy")
HUC12_discharge(HUC12_match_ag,ECHO.test_match_ag,"Matched Agriculture/Irrigation Facilities","match_ag")
HUC12_discharge(HUC12_match_commercial,ECHO.test_match_commercial,"Matched Commercial Facilities","macth_commercial")
HUC12_discharge(HUC12_match_industrial,ECHO.test_match_industrial,"Matched Industrial Facilities","match_industrial")
HUC12_discharge(HUC12_match_municipal,ECHO.test_match_municipal,"Matched Municipal Facilities","match_municipal")

#---Non-Energy Sectors---#

#-All Facilities-#
HUC12_discharge(HUC12_nonenergy,ECHO.test_nonenergy,"Non-Energy Facilities","all_nonenergy")

#-Fully Matched Facilities-#
HUC12_discharge(HUC12_match_nonenergy,ECHO.test_match_nonenergy,"Matched Non-Energy Facilities","match_nonenergy")

###########################################################################################################################################
#-----------------------------------------Distribution of Withdrawing Facilities in HUC12------------------------------------------------#

HUC12_withdrawal<- function(HUC12,VWUDS_points,label,fileext){
  ...
  path="G:/My Drive/USGS_ConsumptiveUse/Spring, 2019/HUC12 Analysis/Withdrawals/"
  
  ggsave(filename=paste0(path,"HUC12_withdrawal_",fileext,".pdf"), 
         plot=plot1, 
         width=13.33, height=6.66,units="in")
...
#-All Facilities-#
HUC12_withdrawal(HUC12,VWUDS.test,"All Reporting Facilities in All Sectors","all_fac_all_sec")
#-Fully Matched Facilities-#
HUC12_withdrawal(HUC12_matched,VWUDS.test_matched,"Matched Facilities in All Sectors","match_all_sector")

#---Subsetted by Sector---#

#-All Facilities-#
HUC12_withdrawal(HUC12_energy,VWUDS.test_energy,"Energy Facilities","all_energy")
HUC12_withdrawal(HUC12_ag,VWUDS.test_ag,"Agriculture/Irrigation Facilities","all_ag")
HUC12_withdrawal(HUC12_commercial,VWUDS.test_commercial,"Commercial Facilities","all_commercial")
HUC12_withdrawal(HUC12_industrial,VWUDS.test_industrial,"Industrial Facilities","all_industrial")
HUC12_withdrawal(HUC12_municipal,VWUDS.test_municipal,"Municipal Facilities","all_municipal")

#-Fully Matched Facilities-#
HUC12_withdrawal(HUC12_match_energy,VWUDS.test_match_energy,"Matched Energy Facilities","match_energy")
HUC12_withdrawal(HUC12_match_ag,VWUDS.test_match_ag,"Matched Agriculture/Irrigation Facilities","match_ag")
HUC12_withdrawal(HUC12_match_commercial,VWUDS.test_match_commercial,"Matched Commercial Facilities","match_commercial")
HUC12_withdrawal(HUC12_match_industrial,VWUDS.test_match_industrial,"Matched Industrial Facilities","match_industrial")
HUC12_withdrawal(HUC12_match_municipal,VWUDS.test_match_municipal,"Matched Municipal Facilities","match_municipal")

#---Non-Energy Sectors---#

#-All Facilities-#
HUC12_withdrawal(HUC12_nonenergy,VWUDS.test_nonenergy,"Non-Energy Facilities","all_nonenergy")

#-Fully Matched Facilities-#
HUC12_withdrawal(HUC12_match_nonenergy,VWUDS.test_match_nonenergy,"Matched Non-Energy Facilities","match_nonenergy")

###########################################################################################################################################
#---------------------------------------------------Consumption over HUC12 Watersheds-------------------------------------------------------------#

HUC12_consumption<- function(HUC12, ECHO_points ,VWUDS_points, label,fileext){
  ...
  path="G:/My Drive/USGS_ConsumptiveUse/Spring, 2019/HUC12 Analysis/Consumption/"
  
  ggsave(filename=paste0(path,"HUC12_CU_",fileext,".pdf"), 
         plot=plot1, 
         width=13.33, height=6.66,units="in")
...
HUC12_consumption(HUC12,ECHO.test,VWUDS.test,"All Reporting Facilities in All Sectors","all_fac_all_sector")

#-Fully Matched Facilities-#

HUC12_consumption(HUC12_matched,ECHO.test_matched,VWUDS.test_matched,"Matched Facilities in All Sectors","match_all_sector")

#---Subsetted by Sector---#

#-All Facilities-#
HUC12_consumption(HUC12_energy,ECHO.test_energy,VWUDS.test_energy,"Energy Facilities","all_energy")
HUC12_consumption(HUC12_ag,ECHO.test_ag,VWUDS.test_ag,"Agriculture/Irrigation Facilities","all_ag")
HUC12_consumption(HUC12_commercial,ECHO.test_commercial,VWUDS.test_commercial,"Commercial Facilities","all_commercial")
HUC12_consumption(HUC12_industrial,ECHO.test_industrial,VWUDS.test_industrial,"Industrial Facilities","all_industrial")
HUC12_consumption(HUC12_municipal,ECHO.test_municipal,VWUDS.test_municipal,"Municipal Facilities","all_municipal")

#-Fully Matched Facilities-#
HUC12_consumption(HUC12_match_energy,ECHO.test_match_energy,VWUDS.test_match_energy,"Matched Energy Facilities","match_energy")
HUC12_consumption(HUC12_match_ag,ECHO.test_match_ag,VWUDS.test_match_ag,"Matched Agriculture/Irrigation Facilities","match_ag")
HUC12_consumption(HUC12_match_commercial,ECHO.test_match_commercial,VWUDS.test_match_commercial,"Matched Commercial Facilities","match_commercial")
HUC12_consumption(HUC12_match_industrial,ECHO.test_match_industrial,VWUDS.test_match_industrial,"Matched Industrial Facilities","match_industrial")
HUC12_consumption(HUC12_match_municipal,ECHO.test_match_municipal,VWUDS.test_match_municipal,"Matched Municipal Facilities","match_municipal")

#---Non-Energy Sectors---#

#-All Facilities-#
HUC12_consumption(HUC12_nonenergy,ECHO.test_nonenergy,VWUDS.test_nonenergy,"Non-Energy Facilities","all_nonenergy")

#-Fully Matched Facilities-#
HUC12_consumption(HUC12_match_nonenergy,ECHO.test_match_nonenergy,VWUDS.test_match_nonenergy,"Matched Non-Energy Facilities","match_nonenergy")

###########################################################################################################################################
#-----------------------------------------Consumption over HUC12 Watersheds (without points)------------------------------------------------------#

HUC12_consumption_nopnt<- function(HUC12, label,fileext){
  ...
  ggsave(filename=paste0(path,"HUC12_CU_nopnt_",fileext,".pdf"), 
         plot=plot1, 
         width=13.33, height=6.66,units="in")
...
#-All Facilities-#
HUC12_consumption_nopnt(HUC12,"All Reporting Facilities in All Sectors","all_fac_all_sector")
#-Fully Matched Facilities-#
HUC12_consumption_nopnt(HUC12_matched,"Matched Facilities in All Sectors","match_all_sector")

#---Subsetted by Sector---#

#-All Facilities-#
HUC12_consumption_nopnt(HUC12_energy,"Energy Facilities","all_energy")
HUC12_consumption_nopnt(HUC12_ag,"Agriculture/Irrigation Facilities","all_ag")
HUC12_consumption_nopnt(HUC12_commercial,"Commercial Facilities","all_commercial")
HUC12_consumption_nopnt(HUC12_industrial,"Industrial Facilities","all_industrial")
HUC12_consumption_nopnt(HUC12_municipal,"Municipal Facilities","all_municipal")

#-Fully Matched Facilities-#
HUC12_consumption_nopnt(HUC12_match_energy,"Matched Energy Facilities","match_energy")
HUC12_consumption_nopnt(HUC12_match_ag,"Matched Agriculture/Irrigation Facilities","match_ag")
HUC12_consumption_nopnt(HUC12_match_commercial,"Matched Commercial Facilities","match_commercial")
HUC12_consumption_nopnt(HUC12_match_industrial,"Matched Industrial Facilities","match_industrial")
HUC12_consumption_nopnt(HUC12_match_municipal,"Matched Municipal Facilities",",match_municipal")

#---Non-Energy Sectors---#

#-All Facilities-#
HUC12_consumption_nopnt(HUC12_nonenergy,"Non-Energy Facilities","all_nonenergy")

#-Fully Matched Facilities-#
HUC12_consumption_nopnt(HUC12_nonenergy,"Matched Non-Energy Facilities","match_nonenergy")
...
MK_HUC12_Compile<- function(ECHO_2010_2017,VWUDS_2010_2017,label){
  ...
  save(TS_CU_HUC12,file=paste0("G:/My Drive/ECHO NPDES/USGS_Consumptive_Use_Updated/Code/R Workspaces/HUC12_",label,".RData"))
