...
all_discharge<- function(discharge_db,label){
  ...
  #--Sum Discharges in the HUC 10 Watersheds--#
...
HUC10_discharge_withdrawal<- function(HUC10_Discharges,HUC10_Withdrawals,label){
  #---Year 2010----#
...
#-All Facilities-#
HUC10_discharge_withdrawal(HUC10_Discharges,HUC10_Withdrawals,"")

#-Fully Matched Facilities-#
HUC10_discharge_withdrawal(HUC10_Discharges_matched,HUC10_Withdrawals_matched,"_matched")

#---Subsetted by Sector---#

#-All Facilities-#
HUC10_discharge_withdrawal(HUC10_Discharges_energy,HUC10_Withdrawals_energy,"_energy")
HUC10_discharge_withdrawal(HUC10_Discharges_ag,HUC10_Withdrawals_ag,"_ag")
...
#-Fully Matched Facilities-#
HUC10_discharge_withdrawal(HUC10_Discharges_match_energy,HUC10_Withdrawals_match_energy,"_match_energy")
HUC10_discharge_withdrawal(HUC10_Discharges_match_ag,HUC10_Withdrawals_match_ag,"_match_ag")
HUC10_discharge_withdrawal(HUC10_Discharges_match_commercial,HUC10_Withdrawals_match_commercial,"_match_commercial")
HUC10_discharge_withdrawal(HUC10_Discharges_match_industrial,HUC10_Withdrawals_match_industrial,"_match_industrial")
HUC10_discharge_withdrawal(HUC10_Discharges_match_municipal,HUC10_Withdrawals_match_municipal,"_match_municipal")
...
#-Fully Matched Facilities-#
HUC10_discharge_withdrawal(HUC10_Discharges_match_nonenergy,HUC10_Withdrawals_match_nonenergy,"_match_nonenergy")


rm(HUC10_Discharges,HUC10_Discharges_ag,HUC10_Discharges_commercial,HUC10_Discharges_energy,HUC10_Discharges_industrial,HUC10_Discharges_match_ag,
   HUC10_Discharges_match_commercial,HUC10_Discharges_match_energy,HUC10_Discharges_match_industrial,HUC10_Discharges_match_municipal,HUC10_Discharges_match_nonenergy,
   HUC10_Discharges_matched,HUC10_Withdrawals,HUC10_Withdrawals_ag,HUC10_Withdrawals_commercial,HUC10_Withdrawals_energy,HUC10_Withdrawals_industrial,
   HUC10_Withdrawals_match_ag,HUC10_Withdrawals_match_commercial,HUC10_Withdrawals_match_energy,HUC10_Withdrawals_match_industrial,HUC10_Withdrawals_match_municipal,
   HUC10_Withdrawals_match_nonenergy,HUC10_Discharges_municipal,HUC10_Discharges_nonenergy,HUC10_Withdrawals_matched,HUC10_Withdrawals_municipal,HUC10_Withdrawals_nonenergy)

###########################################################################################################################################
#-----------------------------------------------Net Water Balance and Consumtpive Use-----------------------------------------------------#

NWB_CU<- function(HUC10,label){
  #---Year 2010----#
...
#-Fully Matched Facilities-#
NWB_CU(HUC10_match_energy,"_match_energy")
NWB_CU(HUC10_match_ag,"_match_ag")
NWB_CU(HUC10_match_commercial,"_match_commercial")
NWB_CU(HUC10_match_industrial,"_match_industrial")
NWB_CU(HUC10_match_municipal,"_match_municipal")
...
#-Fully Matched Facilities-#
NWB_CU(HUC10_match_nonenergy,"_match_nonenergy")
...
Ave_NWB_CU<- function(HUC10,label){
  ...
  for (i in 1:nrow(HUC10@data)){
    HUC10@data$Discharge_ave[i]<-HUC10@data$Discharge_sum[i]/
      length(which(!is.na(HUC10@data[i,c("Discharges_2010","Discharges_2011","Discharges_2012",
  ...
  for (i in 1:nrow(HUC10@data)){
    HUC10@data$Withdrawal_ave[i]<-HUC10@data$Withdrawal_sum[i]/
      length(which(!is.na(HUC10@data[i,c("Withdrawals_2010","Withdrawals_2011","Withdrawals_2012",
                                        "Withdrawals_2013","Withdrawals_2014","Withdrawals_2015",
                                        "Withdrawals_2016","Withdrawals_2017")])))
  }
  ...
  for (i in 1:nrow(HUC10@data)){
    HUC10@data$NetWB_ave[i]<-HUC10@data$NetWB_sum[i]/
      length(which(!is.na(HUC10@data[i,c("NetWB_2010","NetWB_2011","NetWB_2012",
                                        "NetWB_2013","NetWB_2014","NetWB_2015",
                                        "NetWB_2016","NetWB_2017")])))
  }
  ...
  for (i in 1:nrow(HUC10@data)){
    HUC10@data$Consumption_ave[i]<-HUC10@data$Consumption_sum[i]/
      length(which(!is.na(HUC10@data[i,c("Consumption_2010","Consumption_2011","Consumption_2012",
                                        "Consumption_2013","Consumption_2014","Consumption_2015",
                                        "Consumption_2016","Consumption_2017")])))
  }
  ...
  for (i in 1:nrow(HUC10@data)){
    HUC10@data$NetWB_t_ave[i]<-HUC10@data$NetWB_t_sum[i]/
      length(which(!is.na(HUC10@data[i,c("NetWB_2010_t","NetWB_2011_t","NetWB_2012_t",
                                        "NetWB_2013_t","NetWB_2014_t","NetWB_2015_t",
                                        "NetWB_2016_t","NetWB_2017_t")])))
  }
  ...
  for (i in 1:nrow(HUC10@data)){
    HUC10@data$Consumption_t_ave[i]<-HUC10@data$Consumption_t_sum[i]/
      length(which(!is.na(HUC10@data[i,c("Consumption_2010_t","Consumption_2011_t","Consumption_2012_t",
                                        "Consumption_2013_t","Consumption_2014_t","Consumption_2015_t",
                                        "Consumption_2016_t","Consumption_2017_t")])))
  }
...
Ave_NWB_CU(HUC10,"")
#-Fully Matched Facilities-#
Ave_NWB_CU(HUC10_matched,"_matched")

#---Subsetted by Sector---#

#-All Facilities-#
Ave_NWB_CU(HUC10_energy,"_energy")
Ave_NWB_CU(HUC10_ag,"_ag")
Ave_NWB_CU(HUC10_commercial,"_commercial")
Ave_NWB_CU(HUC10_industrial,"_industrial")
Ave_NWB_CU(HUC10_municipal,"_municipal")

#-Fully Matched Facilities-#
Ave_NWB_CU(HUC10_match_energy,"_match_energy")
Ave_NWB_CU(HUC10_match_ag,"_match_ag")
Ave_NWB_CU(HUC10_match_commercial,"_match_commercial")
Ave_NWB_CU(HUC10_match_industrial,"_match_industrial")
Ave_NWB_CU(HUC10_match_municipal,"_match_municipal")
...
#-Fully Matched Facilities-#
Ave_NWB_CU(HUC10_match_nonenergy,"_match_nonenergy")
...
###########################################################################################################################################
#-------------------------------------------Distribution of Discharging Facilities in HUC10----------------------------------------------#

HUC10_discharge<- function(HUC10,ECHO_points, label,fileext){
  ...
  plot1<-ggplot()+
    geom_polygon(
      ...
      aes(x=long, y= lat, group=group,
          fill= cut(HUC10.df$Discharge_ave,breaks=c(0,1,5,10,25,50,max(HUC10.df$Discharge_ave,na.rm=T)),include.lowest=T), colour=""))+
  ...
  path="G:/My Drive/USGS_ConsumptiveUse/Spring, 2019/HUC10 Analysis/Discharges/"
  
  ggsave(filename=paste0(path,"HUC10_discharge_",fileext,".pdf"), 
         plot=plot1, 
...
#-All Facilities-#
HUC10_discharge(HUC10,ECHO.test,"All Reporting Facilities in All Sectors","all_fac_all_sec")
#-Fully Matched Facilities-#
HUC10_discharge(HUC10_matched,ECHO.test_matched,"Matched Facilities in All Sectors","match_all_sector")

#---Subsetted by Sector---#

#-All Facilities-#
HUC10_discharge(HUC10_energy,ECHO.test_energy,"Energy Facilities","all_energy")
HUC10_discharge(HUC10_ag,ECHO.test_ag,"Agriculture/Irrigation Facilities","all_ag")
HUC10_discharge(HUC10_commercial,ECHO.test_commercial,"Commercial Facilities","all_commercial")
HUC10_discharge(HUC10_industrial,ECHO.test_industrial,"Industrial Facilities","all_industrial")
HUC10_discharge(HUC10_municipal,ECHO.test_municipal,"Municipal Facilities","all_municipal")

#-Fully Matched Facilities-#
HUC10_discharge(HUC10_match_energy,ECHO.test_match_energy,"Matched Energy Facilities","match_energy")
HUC10_discharge(HUC10_match_ag,ECHO.test_match_ag,"Matched Agriculture/Irrigation Facilities","match_ag")
HUC10_discharge(HUC10_match_commercial,ECHO.test_match_commercial,"Matched Commercial Facilities","macth_commercial")
HUC10_discharge(HUC10_match_industrial,ECHO.test_match_industrial,"Matched Industrial Facilities","match_industrial")
HUC10_discharge(HUC10_match_municipal,ECHO.test_match_municipal,"Matched Municipal Facilities","match_municipal")

#---Non-Energy Sectors---#

#-All Facilities-#
HUC10_discharge(HUC10_nonenergy,ECHO.test_nonenergy,"Non-Energy Facilities","all_nonenergy")

#-Fully Matched Facilities-#
HUC10_discharge(HUC10_match_nonenergy,ECHO.test_match_nonenergy,"Matched Non-Energy Facilities","match_nonenergy")

###########################################################################################################################################
#-----------------------------------------Distribution of Withdrawing Facilities in HUC10------------------------------------------------#

HUC10_withdrawal<- function(HUC10,VWUDS_points,label,fileext){
  ...
  plot1<-ggplot()+
    geom_polygon(
      data=HUC10.df,
      aes(x=long, y= lat, group=group,
          fill= cut(HUC10.df$Withdrawal_ave,breaks=c(0,1,5,10,25,50,max(HUC10.df$Withdrawal_ave,na.rm=TRUE)),include.lowest=T), colour=""))+
  ...
  path="G:/My Drive/USGS_ConsumptiveUse/Spring, 2019/HUC10 Analysis/Withdrawals/"
  
  ggsave(filename=paste0(path,"HUC10_withdrawal_",fileext,".pdf"), 
         plot=plot1, 
         width=13.33, height=6.66,units="in")
...
#-All Facilities-#
HUC10_withdrawal(HUC10,VWUDS.test,"All Reporting Facilities in All Sectors","all_fac_all_sec")
#-Fully Matched Facilities-#
HUC10_withdrawal(HUC10_matched,VWUDS.test_matched,"Matched Facilities in All Sectors","match_all_sector")

#---Subsetted by Sector---#

#-All Facilities-#
HUC10_withdrawal(HUC10_energy,VWUDS.test_energy,"Energy Facilities","all_energy")
HUC10_withdrawal(HUC10_ag,VWUDS.test_ag,"Agriculture/Irrigation Facilities","all_ag")
HUC10_withdrawal(HUC10_commercial,VWUDS.test_commercial,"Commercial Facilities","all_commercial")
HUC10_withdrawal(HUC10_industrial,VWUDS.test_industrial,"Industrial Facilities","all_industrial")
HUC10_withdrawal(HUC10_municipal,VWUDS.test_municipal,"Municipal Facilities","all_municipal")

#-Fully Matched Facilities-#
HUC10_withdrawal(HUC10_match_energy,VWUDS.test_match_energy,"Matched Energy Facilities","match_energy")
HUC10_withdrawal(HUC10_match_ag,VWUDS.test_match_ag,"Matched Agriculture/Irrigation Facilities","match_ag")
HUC10_withdrawal(HUC10_match_commercial,VWUDS.test_match_commercial,"Matched Commercial Facilities","match_commercial")
HUC10_withdrawal(HUC10_match_industrial,VWUDS.test_match_industrial,"Matched Industrial Facilities","match_industrial")
HUC10_withdrawal(HUC10_match_municipal,VWUDS.test_match_municipal,"Matched Municipal Facilities","match_municipal")

#---Non-Energy Sectors---#

#-All Facilities-#
HUC10_withdrawal(HUC10_nonenergy,VWUDS.test_nonenergy,"Non-Energy Facilities","all_nonenergy")

#-Fully Matched Facilities-#
HUC10_withdrawal(HUC10_match_nonenergy,VWUDS.test_match_nonenergy,"Matched Non-Energy Facilities","match_nonenergy")

###########################################################################################################################################
#---------------------------------------------------Consumption over HUC10 Watersheds-------------------------------------------------------------#

HUC10_consumption<- function(HUC10, ECHO_points ,VWUDS_points, label,fileext){
  ...
  path="G:/My Drive/USGS_ConsumptiveUse/Spring, 2019/HUC10 Analysis/Consumption/"
  
  ggsave(filename=paste0(path,"HUC10_CU_",fileext,".pdf"), 
         plot=plot1, 
         width=13.33, height=6.66,units="in")
...
HUC10_consumption(HUC10,ECHO.test,VWUDS.test,"All Reporting Facilities in All Sectors","all_fac_all_sector")

#-Fully Matched Facilities-#

HUC10_consumption(HUC10_matched,ECHO.test_matched,VWUDS.test_matched,"Matched Facilities in All Sectors","match_all_sector")

#---Subsetted by Sector---#

#-All Facilities-#
HUC10_consumption(HUC10_energy,ECHO.test_energy,VWUDS.test_energy,"Energy Facilities","all_energy")
HUC10_consumption(HUC10_ag,ECHO.test_ag,VWUDS.test_ag,"Agriculture/Irrigation Facilities","all_ag")
HUC10_consumption(HUC10_commercial,ECHO.test_commercial,VWUDS.test_commercial,"Commercial Facilities","all_commercial")
HUC10_consumption(HUC10_industrial,ECHO.test_industrial,VWUDS.test_industrial,"Industrial Facilities","all_industrial")
HUC10_consumption(HUC10_municipal,ECHO.test_municipal,VWUDS.test_municipal,"Municipal Facilities","all_municipal")

#-Fully Matched Facilities-#
HUC10_consumption(HUC10_match_energy,ECHO.test_match_energy,VWUDS.test_match_energy,"Matched Energy Facilities","match_energy")
HUC10_consumption(HUC10_match_ag,ECHO.test_match_ag,VWUDS.test_match_ag,"Matched Agriculture/Irrigation Facilities","match_ag")
HUC10_consumption(HUC10_match_commercial,ECHO.test_match_commercial,VWUDS.test_match_commercial,"Matched Commercial Facilities","match_commercial")
HUC10_consumption(HUC10_match_industrial,ECHO.test_match_industrial,VWUDS.test_match_industrial,"Matched Industrial Facilities","match_industrial")
HUC10_consumption(HUC10_match_municipal,ECHO.test_match_municipal,VWUDS.test_match_municipal,"Matched Municipal Facilities","match_municipal")

#---Non-Energy Sectors---#

#-All Facilities-#
HUC10_consumption(HUC10_nonenergy,ECHO.test_nonenergy,VWUDS.test_nonenergy,"Non-Energy Facilities","all_nonenergy")

#-Fully Matched Facilities-#
HUC10_consumption(HUC10_match_nonenergy,ECHO.test_match_nonenergy,VWUDS.test_match_nonenergy,"Matched Non-Energy Facilities","match_nonenergy")

###########################################################################################################################################
#-----------------------------------------Consumption over HUC10 Watersheds (without points)------------------------------------------------------#

HUC10_consumption_nopnt<- function(HUC10, label,fileext){
  ...
  ggsave(filename=paste0(path,"HUC10_CU_nopnt_",fileext,".pdf"), 
         plot=plot1, 
         width=13.33, height=6.66,units="in")
...
#-All Facilities-#
HUC10_consumption_nopnt(HUC10,"All Reporting Facilities in All Sectors","all_fac_all_sector")
#-Fully Matched Facilities-#
HUC10_consumption_nopnt(HUC10_matched,"Matched Facilities in All Sectors","match_all_sector")

#---Subsetted by Sector---#

#-All Facilities-#
HUC10_consumption_nopnt(HUC10_energy,"Energy Facilities","all_energy")
HUC10_consumption_nopnt(HUC10_ag,"Agriculture/Irrigation Facilities","all_ag")
HUC10_consumption_nopnt(HUC10_commercial,"Commercial Facilities","all_commercial")
HUC10_consumption_nopnt(HUC10_industrial,"Industrial Facilities","all_industrial")
HUC10_consumption_nopnt(HUC10_municipal,"Municipal Facilities","all_municipal")

#-Fully Matched Facilities-#
HUC10_consumption_nopnt(HUC10_match_energy,"Matched Energy Facilities","match_energy")
HUC10_consumption_nopnt(HUC10_match_ag,"Matched Agriculture/Irrigation Facilities","match_ag")
HUC10_consumption_nopnt(HUC10_match_commercial,"Matched Commercial Facilities","match_commercial")
HUC10_consumption_nopnt(HUC10_match_industrial,"Matched Industrial Facilities","match_industrial")
HUC10_consumption_nopnt(HUC10_match_municipal,"Matched Municipal Facilities",",match_municipal")

#---Non-Energy Sectors---#

#-All Facilities-#
HUC10_consumption_nopnt(HUC10_nonenergy,"Non-Energy Facilities","all_nonenergy")

#-Fully Matched Facilities-#
HUC10_consumption_nopnt(HUC10_match_nonenergy,"Matched Non-Energy Facilities","match_nonenergy")
...
full_match_2010_2017_summary<-full_match_2010_2017%>%dplyr::group_by(VPDES.Facility.ID)%>%
  dplyr::summarise(VWUDS.Facility.ID=first(VWUDS.Facility.ID),OutfallID=first(OutfallID),VWUDS.Name=first(VWUDS.Name),VPDES.Name=first(VPDES.Name),
                   ...
                   Ave_Withdrawal_mgd=mean(Withdrawals_MGD,na.rm=T),Ave_Discharge_mgd=mean(Discharges_MGD,na.rm=T),HUC10Name=first(HUC10Name),Waterbody=first(Waterbody))
...
case.study.location<- function(VPDES.ID,VWUDS.ID){
  ...
  ggplot()+
    ...
    geom_label_repel(aes(label=full_match_2010_2017_summary$VPDES_HUC10[full_match_2010_2017_summary$VPDES.Facility.ID==VPDES.ID],
    ...
    geom_label_repel(aes(label=full_match_2010_2017_summary$VWUDS_HUC10[full_match_2010_2017_summary$VWUDS.Facility.ID==VWUDS.ID], 
...
MK_HUC10_Compile<- function(ECHO_2010_2017,VWUDS_2010_2017,label){
  
  HUC10<-as.vector(HUC10@data$HUC10)
  
  TS_HUC10_Discharges<-ECHO_2010_2017%>%
    dplyr::group_by(Date,HUC10)%>%
    dplyr::summarise(Discharge=sum(Discharges_MGD,na.rm=T))%>%
    tidyr::spread(HUC10, Discharge)
  
  Missing<-setdiff(HUC10,names(TS_HUC10_Discharges))
  TS_HUC10_Discharges[Missing]<-NA
  TS_HUC10_Discharges<-TS_HUC10_Discharges[HUC10]
  
  TS_HUC10_Withdrawals<-VWUDS_2010_2017%>%
    dplyr::group_by(Date,HUC10)%>%
    dplyr::summarise(Withdrawal=sum(Withdrawals_MGD,na.rm=T))%>%
    tidyr::spread(HUC10, Withdrawal)
  
  Missing<-setdiff(HUC10,names(TS_HUC10_Withdrawals))
  TS_HUC10_Withdrawals[Missing]<-NA
  TS_HUC10_Withdrawals<-TS_HUC10_Withdrawals[HUC10]
  
  # Timeseries Consumption in HUC10 for Mann Kendall Analysis
  CU_Function<-function(x,y) (ifelse(is.na(x),0,x)-ifelse(is.na(y),0,y))/(ifelse(is.na(x),0,x))
  TS_HUC10_Withdrawals<-TS_HUC10_Withdrawals[,order(names(TS_HUC10_Withdrawals))]
  TS_HUC10_Discharges<-TS_HUC10_Discharges[,order(names(TS_HUC10_Discharges))]
  
  TS_CU_HUC10<-data.frame(Date=unique(VWUDS_2010_2017$Date),mapply(CU_Function,TS_HUC10_Withdrawals,TS_HUC10_Discharges),stringsAsFactors = F)
  
  colnames(TS_CU_HUC10)<-gsub("X","",colnames(TS_CU_HUC10))
  
  assign(label,TS_CU_HUC10,envir = .GlobalEnv)
  
  save(TS_CU_HUC10,file=paste0("G:/My Drive/ECHO NPDES/USGS_Consumptive_Use_Updated/Code/R Workspaces/HUC10_",label,".RData"))
  
}

#---All Sectors---#
#-All Facilities-#
MK_HUC10_Compile(ECHO.test,VWUDS.test,"TS_CU_All")
#-Fully Matched Facilities-#
MK_HUC10_Compile(ECHO.test_matched,VWUDS.test_matched,"TS_CU_Matched")

#---Subsetted by Sector---#

#-All Facilities-#
MK_HUC10_Compile(ECHO.test_energy,VWUDS.test_energy,"TS_CU_All_Energy")
MK_HUC10_Compile(ECHO.test_ag,VWUDS.test_ag,"TS_CU_All_Ag")
MK_HUC10_Compile(ECHO.test_commercial,VWUDS.test_commercial,"TS_CU_All_Commercial")
MK_HUC10_Compile(ECHO.test_industrial,VWUDS.test_industrial,"TS_CU_All_Industrial")
MK_HUC10_Compile(ECHO.test_municipal,VWUDS.test_municipal,"TS_CU_All_Municipal")

#-Fully Matched Facilities-#
MK_HUC10_Compile(ECHO.test_match_energy,VWUDS.test_match_energy,"TS_CU_Match_Energy")
MK_HUC10_Compile(ECHO.test_match_ag,VWUDS.test_match_ag,"TS_CU_Match_Ag")
MK_HUC10_Compile(ECHO.test_match_commercial,VWUDS.test_match_commercial,"TS_CU_Match_Commercial")
MK_HUC10_Compile(ECHO.test_match_industrial,VWUDS.test_match_industrial,"TS_CU_Match_Industrial")
MK_HUC10_Compile(ECHO.test_match_municipal,VWUDS.test_match_municipal,"TS_CU_Match_Municipal")

#---Non-Energy Sectors---#

#-All Facilities-#
MK_HUC10_Compile(ECHO.test_nonenergy,VWUDS.test_match_nonenergy,"TS_CU_All_NonEnergy")

#-Fully Matched Facilities-#
MK_HUC10_Compile(ECHO.test_match_nonenergy,VWUDS.test_match_nonenergy,"TS_CU_Match_NonEnergy")
