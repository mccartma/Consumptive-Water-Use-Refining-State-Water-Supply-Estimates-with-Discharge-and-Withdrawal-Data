...
ECHO_timeseries<-ECHO_timeseries[ECHO_timeseries$MP_End_Date %within% interval("2010-01-01","2017-12-31"),]
...
#In personal file
write.table(ECHO_timeseries,"G:/My Drive/ECHO NPDES/USGS_Consumptive_Use_Updated/Documentation/Imports/ECHO_timeseries_3_7.txt",sep="\t",row.names = F)
